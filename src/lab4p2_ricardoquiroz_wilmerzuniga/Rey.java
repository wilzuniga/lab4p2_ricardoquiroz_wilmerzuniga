...
public class Rey extends Pieza {
    ...
    public boolean Movimiento(String ubiactual, String destino, Object[][] tablero) {
        ...
        if (((char) (tablero[x1][y1])) == 'K' || ((char) (tablero[x1][y1])) == 'k') {
            if (tablero[x2][y2] == " ") {
                if ((x2 == x1 || y2 == y1) && Math.abs(y2 - y1) == Math.abs(x2 - x1) && Math.abs(y2 - y1) == 1 && Math.abs(x2 - x1) == 1) {
                    if (((Rey) (tablero[x1][y1])).getRep() == 'K') {
                        tablero[x2][y2] = new Rey(x2, y2, 'k');
                        tablero[x1][y1] = " ";
                        coso = true;
