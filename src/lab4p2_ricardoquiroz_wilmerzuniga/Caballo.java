...
public class Caballo extends Pieza {
    ...
    public boolean Movimiento(String ubiactual, String destino, Object[][] tablero) {
        ...
        if (((char) (tablero[x1][y1])) == 'N' || ((char) (tablero[x1][y1])) == 'n') {
            if (tablero[x2][y2] == " ") {
                if ((Math.abs(y2 - y1) == 2 && Math.abs(x2 - x1) == 1) || (Math.abs(x2 - x1) == 2 && Math.abs(y2 - y1) == 1)) {
                    if (((Caballo) (tablero[x1][y1])).getRep() == 'n') {
                        tablero[x2][y2] = new Caballo(x2, y2, 'n');
                        tablero[x1][y1] = " ";
                        coso = true;
